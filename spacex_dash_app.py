...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names = 'Launch Site',
        title = 'Percentage of successful launches')
        return fig
    else:
        ...
        fig = px.pie(filtered_df,
                     values = 'class count',
                     names = 'class',
                     title = f'Percentage of launches from {entered_site}'
                     )
        return fig
...
def get_scatter(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df1, x= "Payload Mass (kg)", y = "class", color = "Booster Version Category", title = f"Payload vs. Outcomes for {entered_site}")
        return fig
# Run the app
